...
- Name: responsive_testing/responsive.spec.js >> Responsive UI Module >> Verify responsive layout using test steps
- Location: tests/responsive_testing/responsive.spec.js:235:3
