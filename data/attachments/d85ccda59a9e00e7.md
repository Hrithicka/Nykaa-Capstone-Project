...
- Name: responsive_testing/responsive.spec.js >> Responsive UI Module >> Verify responsive page using soft assertions
- Location: tests/responsive_testing/responsive.spec.js:289:3
